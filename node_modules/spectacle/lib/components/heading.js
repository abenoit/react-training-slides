...
var StyledSpan = /*#__PURE__*/(0, _reactEmotion2.default)('span')(function (_ref2) {
...
var dynamicStyledHeaders = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'].reduce(function (memo, tag) {
  ...
  return (0, _extends4.default)({}, memo, (_extends2 = {}, _extends2[tag] = /*#__PURE__*/ /*#__PURE__*/(0, _reactEmotion2.default)(tag)(dynamicHeaderStyles), _extends2));
}, {});
...
var Heading = function (_Component) {
  ...
  Heading.prototype.render = function render() {
    ...
    if (fit) {
      ...
      }, void 0, (0, _jsx3.default)(StyledSpan, {
